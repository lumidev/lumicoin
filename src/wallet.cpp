...
// lumicoin: total coins staked (non-spendable until maturity)
...
// lumicoin: check 'spent' consistency between wallet and txindex
// lumicoin: fix wallet spent state according to txindex
...
// lumicoin: disable transaction (only for coinstake)
